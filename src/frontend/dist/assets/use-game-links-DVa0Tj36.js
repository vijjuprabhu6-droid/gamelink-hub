...
import { p as ProtocolError, T as TimeoutWaitingForResponseErrorCode, q as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, s as lookupResultToBuffer, t as RequestStatusResponseStatus, U as UnknownError, v as RequestStatusDoneNoReplyErrorCode, w as RejectError, x as CertifiedRejectErrorCode, y as UNREACHABLE_ERROR, I as InputError, z as InvalidReadStateRequestErrorCode, A as ReadRequestType, D as Principal, F as IDL, H as MissingCanisterIdErrorCode, J as HttpAgent, K as encode, Q as QueryResponseStatus, N as UncertifiedRejectErrorCode, O as isV3ResponseBody, V as isV2ResponseBody, W as UncertifiedRejectUpdateErrorCode, X as UnexpectedErrorCode, Y as decode, Z as Subscribable, _ as pendingThenable, $ as resolveEnabled, a0 as shallowEqualObjects, a1 as resolveStaleTime, a2 as noop, a3 as environmentManager, a4 as isValidTimeout, a5 as timeUntilStale, a6 as timeoutManager, a7 as focusManager, a8 as fetchState, a9 as replaceData, aa as notifyManager, ab as hashKey, ac as getDefaultState, r as reactExports, ad as shouldThrowError, ae as useQueryClient, af as useInternetIdentity, ag as createActorWithConfig, ah as Record, ai as Opt, aj as Vec, ak as Variant, al as Service, am as Func, an as Text, ao as Nat, ap as Nat8, aq as Bool, ar as Int, as as Principal$1, at as Null } from "./index-m1b7ux88.js";
...
const CreateGameLinkRequest = Record({
  "url": Text,
  "title": Text,
  "description": Text,
  "image": ExternalBlob$1
});
const GameLinkId = Nat;
const GameLink = Record({
  "id": GameLinkId,
  "url": Text,
  "title": Text,
  "submittedAt": Int,
...
const UpdateGameLinkRequest = Record({
  "url": Text,
  "title": Text,
  "description": Text,
  "image": ExternalBlob$1
...
Service({
  ...
  "addGameLink": Func([CreateGameLinkRequest], [GameLink], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "deleteGameLink": Func([GameLinkId], [], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getGameLink": Func([GameLinkId], [Opt(GameLink)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listGameLinks": Func([], [Vec(GameLink)], ["query"]),
  "searchGameLinks": Func([Text], [Vec(GameLink)], ["query"]),
  "updateGameLink": Func(
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreateGameLinkRequest2 = IDL2.Record({
    "url": IDL2.Text,
    "title": IDL2.Text,
    "description": IDL2.Text,
    "image": ExternalBlob2
  });
  const GameLinkId2 = IDL2.Nat;
  const GameLink2 = IDL2.Record({
    "id": GameLinkId2,
    "url": IDL2.Text,
    "title": IDL2.Text,
  ...
  const UpdateGameLinkRequest2 = IDL2.Record({
    "url": IDL2.Text,
    "title": IDL2.Text,
    "description": IDL2.Text,
    "image": ExternalBlob2
  ...
  return IDL2.Service({
    ...
    "addGameLink": IDL2.Func([CreateGameLinkRequest2], [GameLink2], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "deleteGameLink": IDL2.Func([GameLinkId2], [], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getGameLink": IDL2.Func([GameLinkId2], [IDL2.Opt(GameLink2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listGameLinks": IDL2.Func([], [IDL2.Vec(GameLink2)], ["query"]),
    "searchGameLinks": IDL2.Func([IDL2.Text], [IDL2.Vec(GameLink2)], ["query"]),
    "updateGameLink": IDL2.Func(
      [GameLinkId2, UpdateGameLinkRequest2],
      [GameLink2],
      []
    )
  });
...
class Backend {
  ...
  async updateGameLink(arg0, arg1) {
    if (this.processError) {
      try {
...
async function from_candid_GameLink_n11(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n18(_uploadFile, _downloadFile, value) {
...
async function to_candid_CreateGameLinkRequest_n8(_uploadFile, _downloadFile, value) {
...
async function to_candid_UpdateGameLinkRequest_n20(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
...
function useGameLinks() {
  const { backend, isFetching } = useBackend();
  return useQuery({
    queryKey: [QUERY_KEY],
    queryFn: async () => {
      if (!backend) return [];
      return backend.listGameLinks();
    },
    enabled: !!backend && !isFetching
  });
}
function useSearchGameLinks(query) {
  const { backend, isFetching } = useBackend();
  return useQuery({
    queryKey: [QUERY_KEY, "search", query],
    queryFn: async () => {
      if (!backend || !query.trim()) return [];
      return backend.searchGameLinks(query);
    },
    enabled: !!backend && !isFetching && !!query.trim()
  });
}
function useGameLink(id) {
  const { backend, isFetching } = useBackend();
  return useQuery({
    queryKey: [QUERY_KEY, id == null ? void 0 : id.toString()],
    queryFn: async () => {
      if (!backend || id === void 0) return null;
      return backend.getGameLink(id);
    },
    enabled: !!backend && !isFetching && id !== void 0
  });
}
function useAddGameLink() {
  const { backend } = useBackend();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (req) => {
      if (!backend) throw new Error("Backend not available");
      return backend.addGameLink(req);
    },
    onSuccess: () => {
...
function useUpdateGameLink() {
  const { backend } = useBackend();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, request }) => {
      if (!backend) throw new Error("Backend not available");
      return backend.updateGameLink(id, request);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: [QUERY_KEY] });
    }
...
function useDeleteGameLink() {
  const { backend } = useBackend();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (id) => {
      if (!backend) throw new Error("Backend not available");
      return backend.deleteGameLink(id);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: [QUERY_KEY] });
    }
...
export {
  ExternalBlob as E,
  useSearchGameLinks as a,
  useGameLink as b,
  useDeleteGameLink as c,
  useAddGameLink as d,
  useUpdateGameLink as e,
  useGameLinks as u
};
