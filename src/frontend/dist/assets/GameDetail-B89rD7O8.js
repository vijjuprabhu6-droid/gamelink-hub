import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, b as composeRefs, d as reactDomExports, e as useComposedRefs, f as ReactDOM, g as cn, h as buttonVariants, i as useParams, a as useNavigate, u as useAuth, S as Skeleton, B as Button, L as Link, G as Gamepad2, k as ue } from "./index-m1b7ux88.js";
import { B as Badge, E as ExternalLink } from "./badge-Oz5EYX7t.js";
import { b as useGameLink, c as useDeleteGameLink } from "./use-game-links-DVa0Tj36.js";
...
function GameDetailPage() {
  var _a, _b;
  const { id: id2 } = useParams({ from: "/game/$id" });
  const navigate = useNavigate();
  const { isAuthenticated, principal } = useAuth();
  const { data: game, isLoading } = useGameLink(id2 ? BigInt(id2) : void 0);
  const deleteGame = useDeleteGameLink();
  const imageUrl = ((_b = (_a = game == null ? void 0 : game.image) == null ? void 0 : _a.getDirectURL) == null ? void 0 : _b.call(_a)) ?? "/assets/images/placeholder.svg";
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      ue.success("Game link deleted");
      navigate({ to: "/" });
    } catch {
      ue.error("Failed to delete game link");
    }
  };
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-28 mb-6 rounded-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full aspect-video rounded-2xl mb-8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-2/3 mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mb-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-36 rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full mb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-5/6 mb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-4/5 mb-8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-52 rounded-xl" })
        ]
      }
    );
  }
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full bg-destructive/10 border border-destructive/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-10 h-10 text-destructive" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-destructive/5 blur-2xl -z-10" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl text-foreground mb-3", children: "Game Not Found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg mb-8 max-w-sm", children: "This game link may have been removed or never existed. Check the URL and try again." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              asChild: true,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-8", "data-ocid": "game_detail.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent pointer-events-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/80 text-primary-foreground border-primary/50 backdrop-blur-sm gap-1.5 text-xs font-display font-semibold uppercase tracking-wider", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-3 h-3" }),
            "Game"
          ] }) })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 mb-5 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-extrabold text-3xl sm:text-4xl text-foreground flex-1 min-w-0 leading-tight", children: game.title }),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/edit/$id", params: { id: game.id.toString() }, children: [
                      ...
                      AlertDialogContent,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display font-bold text-xl", children: "Delete Game Link" }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              AlertDialogAction,
                              {
                                ...
                                children: deleteGame.isPending ? "Deleting…" : "Delete"
                              }
                            )
                          ] })
                        ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
                variant: "secondary",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(UserRound, { className: "w-3 h-3 shrink-0 text-primary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: truncatePrincipal(game.submittedBy.toString()) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "gap-1.5 px-3 py-1 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-3 h-3 shrink-0 text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatDate(game.submittedAt) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border mb-7" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/80 leading-relaxed text-base mb-10 whitespace-pre-wrap", children: game.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: game.url,
